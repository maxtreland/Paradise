...
*/
	...
	#include "map_files\hispania_ice\hispania_ice.dmm"
	#include "map_files\hispania\z2.dmm"
	#include "map_files\hispania\Lavaland.dmm"

	#define MAP_TRANSITION_CONFIG list(\
DECLARE_LEVEL(MAIN_STATION, CROSSLINKED, list(STATION_LEVEL, STATION_CONTACT, REACHABLE, AI_OK, HAS_WEATHER)),\
DECLARE_LEVEL(CENTCOMM, SELFLOOPING, list(ADMIN_LEVEL, BLOCK_TELEPORT, IMPEDES_MAGIC)),\
DECLARE_LEVEL(MINING, SELFLOOPING, list(ORE_LEVEL, REACHABLE, STATION_CONTACT, HAS_WEATHER, AI_OK)))
	#define USING_MAP_DATUM /datum/map/hispania_ice
